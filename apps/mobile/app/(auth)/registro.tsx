...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 36, fontWeight: '800', color: colors.accent },
  subtitle: { fontSize: 14, color: colors.muted, marginTop: 4 },
  form: { backgroundColor: colors.surface, borderRadius: 16, padding: 24, gap: 16 },
  ...
  button: { backgroundColor: colors.accent, borderRadius: 10, padding: 14, alignItems: 'center', marginTop: 4 },
